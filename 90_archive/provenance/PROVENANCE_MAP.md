...
| `obra/Superpowers` | Inspected at pinned v6.2.0 (`3dcbd5c4`); portable workflow concepts merged. WCBS V2's OpenCode/Pi adapter structure and Windows hook-bridge approach were informed by MIT-licensed source; WCBS payloads, registry, skills, and tests are repository-specific. | `20_skills/`, `40_knowledge/`, `00_start_here/PORTABLE_ADAPTERS.md`, `.opencode/plugins/wcbs.js`, `.pi/extensions/wcbs.ts`, `hooks/run-hook.cmd` |
...
| `everyinc/compound-engineering-plugin` | Inspected by GitHub; compound learning, knowledge refresh, requirement/evidence synthesis, and review finding lifecycle concepts adapted; runtime-specific plugin commands and autonomous shipping mechanics not imported | `skills/compound-learning-capture/SKILL.md`, `skills/knowledge-refresh-and-drift-control/SKILL.md`, `40_knowledge/COMPOUND_LEARNING_GUIDANCE.md`, `60_templates/SOLVED_PROBLEM_LEARNING_TEMPLATE.md`, `60_templates/KNOWLEDGE_REFRESH_REPORT_TEMPLATE.md`, `skills/writing-plans/SKILL.md`, `skills/code-review-and-review-army/SKILL.md`, `skills/data-output-and-reporting/SKILL.md`, `skills/release-readiness-and-ship-gates/SKILL.md`, `50_audits/CANONICAL_AUDIT_PROTOCOLS.md` |
...
- Compound Engineering concepts are merged as APIVR-native learning capture and knowledge refresh workflows, not as plugin commands or autonomous release automation.

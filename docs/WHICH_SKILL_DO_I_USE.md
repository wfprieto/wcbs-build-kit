...
| Work | Skill |
|---|---|
| Start any serious task | `skills/super-build-kit/SKILL.md` |
...
| Release | `skills/release-readiness-and-ship-gates/SKILL.md` |
| Security-sensitive work | `skills/cybersecurity-risk-routing/SKILL.md` |
